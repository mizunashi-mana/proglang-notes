...
\begin{gather*}
  ...
  \\
  \infer[\text{U-Funct}]{\Gamma \vdash \forall \overline{t_1: \kappa_1}\ldotp \Sigma_1 \to \Xi_1 \leq \forall \overline{t_2: \kappa_2}\ldotp \Sigma_2 \to \Xi_2 \elaborate e_3}{
    \begin{array}{ll}
      ...
      \\
      \multicolumn{2}{c}{e_3 = \lambda x_1: (\forall \overline{t_1: \kappa_1}\ldotp \Sigma_1 \to \Xi_1)\ldotp \lambda x_2: \Sigma_2\ldotp e_2\; (x_1\; \overline{\tau}\; (e_1\; x_2))}
    \end{array}
  }
  \\
  \infer[\text{U-Abs}]{\Gamma \vdash \exists \overline{t_1: \kappa_1}\ldotp \Sigma_1 \leq \exists \overline{t_2: \kappa_2}\ldotp \Sigma_2 \elaborate e}{
    \begin{array}{c}
      \Gamma, \overline{t_1: \kappa_1} \vdash \Sigma_1 \leq \exists \overline{t_2: \kappa_2}\ldotp \Sigma_2 \uparrow \overline{\tau} \elaborate e_1
      \\
      e = \lambda x_1: (\exists \overline{t_1: \kappa_1}\ldotp \Sigma_1)\ldotp \symunpack\langle \overline{t_1: \kappa_1}, x'_1: \Sigma_1\rangle = x_1 \symin \sympack\langle \overline{\tau}, e_1\; x'_1\rangle_{\exists \overline{t_2: \kappa_2}\ldotp \Sigma_2}
    \end{array}
  }
\end{gather*}
...
\begin{gather*}
  ...
  \\
  \infer[\text{M-Dot}]{\Gamma \vdash M.X: \exists \overline{t: \kappa}\ldotp \Sigma \elaborate \symunpack\langle \overline{t: \kappa}, x: \{l_X: \Sigma, \overline{l_{X'}: \Sigma'}\}\rangle = e \symin \sympack\langle \overline{t: \kappa}, x.l_X\rangle_{\exists \overline{t: \kappa}\ldotp \Sigma}}{
